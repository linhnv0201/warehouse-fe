...
export default function PurchaseOrderDetail() {
  ...
  useEffect(() => {
    const fetchOrderDetail = async () => {
      try {
        const res = await axios.get(`https://warehouse-production-53d6.up.railway.app/warehouse/purchase-orders/${orderId}`, {
  ...
  const handleApproveOrder = async () => {
    try {
      await axios.patch(`https://warehouse-production-53d6.up.railway.app/warehouse/purchase-orders/${orderId}/status?status=APPROVED`, null, {
        headers: { Authorization: `Bearer ${token}` },
      });
  ...
  const handleCancelOrder = async () => {
    try {
      await axios.patch(`https://warehouse-production-53d6.up.railway.app/warehouse/purchase-orders/${orderId}/status?status=CANCELLED`, null, {
        headers: { Authorization: `Bearer ${token}` },
      });
  ...
  const fetchPurchaseInvoices = async (receiveOrderId) => {
    ...
    try {
      const res = await axios.get(
        `https://warehouse-production-53d6.up.railway.app/warehouse/purchase-invoices/by-receive-order/${receiveOrderId}`,
        {
          headers: { Authorization: `Bearer ${token}` },
        }
      );
  ...
  const fetchReceiveOrders = async () => {
    setLoadingRO(true);
    try {
      const res = await axios.get(`https://warehouse-production-53d6.up.railway.app/warehouse/receive-orders/by-purchase-order/${orderId}`, {
        headers: { Authorization: `Bearer ${token}` },
      });
  ...
  const handleOpenCreateReceiveOrder = async (purchaseOrderId) => {
    try {
      const response = await axios.get(`https://warehouse-production-53d6.up.railway.app/warehouse/purchase-orders/${purchaseOrderId}`, {
        headers: { Authorization: `Bearer ${token}` },
      });
  ...
  const handleCreateReceiveOrder = async (purchaseOrderId) => {
    try {
      ...
      await axios.post(
        `https://warehouse-production-53d6.up.railway.app/warehouse/receive-orders/${purchaseOrderId}`,
        receiveOrderData,
        {
          headers: {
  ...
  const handleOpenDetail = async (receiveOrderId) => {
    try {
      const response = await axios.get(`https://warehouse-production-53d6.up.railway.app/warehouse/receive-orders/${receiveOrderId}`, {
        headers: { Authorization: `Bearer ${token}` },
      });
      if (response.data.code === 0) {
  ...
  const handleCreatePayment = async () => {
    ...
    try {
      const res = await fetch(`https://warehouse-production-53d6.up.railway.app/warehouse/payments/${selectedInvoice.id}`, {
        method: 'POST',
        headers: {
  ...
  const fetchPurchaseInvoiceByRO = async (receiveOrderId) => {
    try {
      const res = await axios.get(`https://warehouse-production-53d6.up.railway.app/warehouse/purchase-invoices/by-receive-order/${receiveOrderId}`, {
        headers: { Authorization: `Bearer ${token}` },
      });
      if (res.data.code === 0) {
  ...
  const fetchPaymentsByInvoice = async (invoiceId) => {
    ...
    try {
      const res = await axios.get(`https://warehouse-production-53d6.up.railway.app/warehouse/payments/by-invoice/${invoiceId}`, {
        headers: { Authorization: `Bearer ${token}` },
      });
      if (res.data.code === 0) {
