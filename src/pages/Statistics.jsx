...
export default function Statistics() {
  ...
  const fetchBestSellers = async () => {
    setLoading(true);
    try {
      const res = await axios.get("http://localhost:8080/warehouse/inventories/best-sellers", {
...
// export default function Statistics() {
//   const [tab, setTab] = useState(0); // 0: purchase, 1: sales, 2: profit
//   const [orders, setOrders] = useState([]);
//   const [filtered, setFiltered] = useState([]);
//   const [total, setTotal] = useState(0);
//   const [chartData, setChartData] = useState([]);
...
//       let ord = ordersRes.data;
//       if (tab === 2) {
//         // Tính lợi nhuận dựa vào estimatedProfit
//         ord = ord.map(o => ({
//           ...o,
//           profit: Number(o.estimatedProfit) || 0
//         }));
